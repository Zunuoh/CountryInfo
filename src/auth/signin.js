    ...
    return(
        <View style={{flex:1, padding:20, backgroundColor:"#D0E1F9"}}>
           ...
           <SigninSvg/>
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate('DetailsScreen')}} style={{height:50, marginTop:30, borderRadius:30, justifyContent:"center", alignItems:"center", backgroundColor:"#4D648D", width:"90%", marginLeft:20}}>
